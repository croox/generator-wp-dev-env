...
- Choose "Regenerate project into generated branch". It checks out `generated`, deletes the generated files (grunt/, src/, dist/, test_build/, Gruntfile.js, README.md, composer.json, composer.lock, package.json, package-lock.json, .eslintrc.json, wde_wp_installs-sample.json, .wde_nextRelease.json, releases/readme.md, vendor/readme.md), re-generates everything from current templates using project metadata from the existing package.json, adds a `changed` entry to .wde_nextRelease.json and commits "Updated to generator-wp-dev-env#… (…)".
