 ...
 */
function <%= funcPrefix %>_add_mobile_parent_nav_menu_items( $sorted_menu_items, $args ) {
	static $pseudo_id = 0;
...
add_filter( 'wp_nav_menu_objects', '<%= funcPrefix %>_add_mobile_parent_nav_menu_items', 10, 2 );